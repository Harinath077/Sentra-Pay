...
# Ensure minimal env for local debug
...
stats = compute_user_stats('user4@upi')
rec = get_receiver_summary_for_user('user4@upi','recv7@upi')
profile = {'user_id':'user4@upi','known_devices':[], 'trust_score':0, 'risk_tier':'BRONZE'}
ctx = UserContext(profile, stats, rec)

txn = {'amount':100, 'receiver':'recv7@upi', 'device_id':'dev-test-1', 'ip_city':'Mumbai'}
